!(function() {
  ...
  function n(e, n, r, i, o, s, a, u, l, c, f, p) {
    ...
    return (
      ...
      !('number' != typeof p || !isFinite(p)) &&
        (e && 0 === parseFloat(p.toFixed(e)) && (p = 0),
        0 > p && ((d = !0), (p = Math.abs(p))),
        e && ((s = Math.pow(10, e)), (p = (Math.round(p * s) / s).toFixed(e))),
        -1 !== (p = p.toString()).indexOf('.') &&
          ((e = p.split('.')), (p = e[0]), r && (f = r + e[1])),
        n && ((p = t(p).match(/.{1,3}/g)), (p = t(p.join(t(n))))),
        d && u && (h += u),
        i && (h += i),
        d && l && (h += l),
        (h = h + p + f),
  ...
  function r(t, e, n, r, i, o, s, a, u, l, c, f) {
    ...
    return (
      ...
      c && (f = c(f)),
      !(!f || 'string' != typeof f) &&
        (a && f.substring(0, a.length) === a && ((f = f.replace(a, '')), (p = !0)),
        r && f.substring(0, r.length) === r && (f = f.replace(r, '')),
        u && f.substring(0, u.length) === u && ((f = f.replace(u, '')), (p = !0)),
        i && f.slice(-1 * i.length) === i && (f = f.slice(0, -1 * i.length)),
        e && (f = f.split(e).join('')),
        n && (f = f.replace(n, '.')),
        p && (t += '-'),
        (t = Number((t + f).replace(/[^0-9\.\-.]/g, ''))),
        s && (t = s(t)),
    ...
    for (n = 0; n < a.length; n += 1)
      (r = a[n]),
        ...
        void 0 === i
          ...
          : 'decimals' === r
          ? 0 < i && 8 > i && (o[r] = i)
          : 'encoder' === r || 'decoder' === r || 'edit' === r || 'undo' === r
          ? 'function' == typeof i && (o[r] = i)
          : 'string' == typeof i && (o[r] = i);
    return (
      e(o, 'mark', 'thousand'), e(o, 'prefix', 'negative'), e(o, 'prefix', 'negativeBefore'), o
    );
  }
  function o(t, e, n) {
    var r,
  ...
  (function(t) {
    ...
    function x(t, e, r, i) {
      ...
      var o,
        ...
        a = b(i, t);
      return r
        ? ((o = t[a - 1]), (s = t[a]), i - o > (s - o) / 2 ? s : o)
        : e[a - 1]
        ? t[a - 1] + n(i - t[a - 1], e[a - 1])
        : i;
    }
    function y(t, e, n) {
      var r;
      if (
        ('number' == typeof e && (e = [e]), '[object Array]' !== Object.prototype.toString.call(e))
      )
        throw new Error("noUiSlider: 'range' contains invalid value.");
      if (((r = 'min' === t ? 0 : 'max' === t ? 100 : parseFloat(t)), !i(r) || !i(e[0])))
    ...
    function X(t) {
      var e = { margin: 0, limit: 0, padding: 0, animate: !0, animationDuration: 300, format: I },
        n = {
          step: { r: !1, t: N },
          start: { r: !0, t: M },
          connect: { r: !0, t: V },
    ...
    function Y(n, i, u) {
      function h(e, n) {
        ...
        return (
          t(o, i.cssClasses.handleTouchArea),
          o.setAttribute('data-handle', n),
          0 === n
            ? l(o, i.cssClasses.handleLower)
            : n === i.handles - 1 && l(o, i.cssClasses.handleUpper),
          r
        );
      }
      function m(e, n) {
        ...
        return (
          ...
          r.forEach(function(e, s) {
            var a,
              ...
              S = r[s + 1];
            if (
              ('steps' === n && (a = tt.xNumSteps[s]), a || (a = S - w), !1 !== w && void 0 !== S)
            )
              for (a = Math.max(a, 1e-7), f = w; f <= S; f = i(f, a)) {
                for (
                  g = (h = (d = tt.toStepping(f)) - c) / t, b = h / (v = Math.round(g)), p = 1;
                  p <= v;
                  p += 1
                )
      ...
      function y(t, e, n, r) {
        var o = function(e) {
            return (
              ...
              (!f(J, i.cssClasses.tap) &&
                (!!(e = E(e, r.pageOffset)) &&
                  (!(t === G.start && void 0 !== e.buttons && e.buttons > 1) &&
                    ((!r.hover || !e.buttons) && ((e.calcPoint = e.points[i.ort]), void n(e, r))))))
            );
          },
          s = [];
        return (
      ...
      function V(t, e) {
        ...
        if (((document.documentElement.noUiListeners = r.concat(o, s)), t.cursor)) {
          (document.body.style.cursor = getComputedStyle(t.target).cursor),
            _.length > 1 && l(J, i.cssClasses.drag);
          var a = function() {
            return !1;
          };
      ...
      function A(t) {
        ...
        var e = C(t.calcPoint),
          n = N(e);
        if (!1 === n) return !1;
        i.events.snap || o(J, i.cssClasses.tap, i.animationDuration),
          D(n, e, !0, !0),
          H(),
          M('slide', n, !0),
          M('set', n, !0),
          M('change', n, !0),
          M('update', n, !0),
          i.events.snap && V(t, { handleNumbers: [n] });
      }
      function L(t) {
        var e = C(t.calcPoint),
          n = tt.getStep(e),
      ...
      function F(t, e, n, r, o) {
        return (
          _.length > 1 &&
            ...
            o && e < _.length - 1 && (n = Math.min(n, t[e + 1] - i.margin))),
          _.length > 1 &&
            i.limit &&
            (r && e > 0 && (n = Math.min(n, t[e - 1] + i.limit)),
            o && e < _.length - 1 && (n = Math.max(n, t[e + 1] - i.limit))),
          i.padding &&
            (0 === e && (n = Math.max(n, i.padding)),
            e === _.length - 1 && (n = Math.min(n, 100 - i.padding))),
          (n = tt.getStep(n)),
          (n = s(n)) !== t[e] && n
        );
      }
      ...
      function T(t) {
        if (W[t]) {
          ...
          0 !== t && (e = K[t - 1]),
            t !== W.length - 1 && (n = K[t]),
            (W[t].style[i.style] = j(e)),
            (W[t].style[i.styleOposite] = j(100 - n));
        }
      }
      function q(t, e) {
        null !== t &&
          ...
          !1 === (t = i.format.from(t)) || isNaN(t) || D(e, tt.toStepping(t), !1, !1));
      }
      function R(t, e) {
        var n = a(t),
          r = void 0 === K[0];
        (e = void 0 === e || !!e),
          n.forEach(q),
          i.animate && !r && o(J, i.cssClasses.tap, i.animationDuration),
          Q.forEach(function(t) {
            D(t, K[t], !0, !1);
          }),
          H(),
        ...
        ($ = {
          ...
          updateOptions: function(t, e) {
            ...
            r.forEach(function(e) {
              ...
              (o.spectrum.direction = tt.direction),
              (tt = o.spectrum),
              (i.margin = o.margin),
              (i.limit = o.limit),
              (i.padding = o.padding),
              ...
              W.forEach(function(e, n) {
                if (!1 !== e && 0 !== n && n !== W.length - 1) {
                  ...
                  l(e, i.cssClasses.draggable),
                    t.fixed && (s.push(r.children[0]), s.push(o.children[0])),
